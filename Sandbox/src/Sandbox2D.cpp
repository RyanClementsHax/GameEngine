...
void Sandbox2D::OnUpdate(GameEngine::Timestep ts)
{
	...
	// std::dynamic_pointer_cast<GemeEngine::OpenGLShader>(m_FlatColorShader)->Bind();
	// std::dynamic_pointer_cast<GemeEngine::OpenGLShader>(m_FlatColorShader)->UploadUniformFloat4("u_Color", m_SquareColor);
}
