...
namespace GameEngine {
	...
	void Renderer2D::Init()
	{
		...
		s_Data->QuadVertexArray = GameEngine::VertexArray::Create();
		...
		s_Data->FlatColorShader = GameEngine::Shader::Create("assets/shaders/FlatColor.glsl");
		s_Data->TextureShader = GameEngine::Shader::Create("assets/shaders/Texture.glsl");
